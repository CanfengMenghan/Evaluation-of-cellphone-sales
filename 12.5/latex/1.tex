...
\multicolumn{1}{|c|}{ROM} & \begin{tabular}[c]{@{}l@{}}Group number in\\   Category Click Rate\end{tabular} & 1   & 2  & 3   & 4   & 5  \\ \hline
                          ...
                          & 256                                                                             & 0   & 0  & 1   & 0   & 0  \\ \hline
\end{tabular}
  \caption{The grouping of ROM related to Category Click Rate}\label{The grouping of ROM related to Category Click Rate}
\end{table}
...
\end{tabular}
  \caption{ Statistics from Battery Capacity to Click Rate Category. The upper-middle Battery Capacity reveals a better sales. }\label{Basic Staatistics}
\end{table}
...
\end{tabular}
  \caption{Linear Regression Coefficient}\label{Linear Regression Coefficientp}
\end{table}
...
\end{tabular}
  \caption{Linear Regression Coefficient Bound}\label{Linear Regression Coefficient Boundp}
\end{table}
...
\end{tabular}
  \caption{Linear Regression Correlation Coefficients, which is not high enough for further analysis. }\label{Linear Regression Correlation Coefficientsp}
\end{table}
